...
loop:
    ...
    // All force to all (separateForces from acceleration apply)
...
*=$2000 "Data"
    body:
        ...
        .word 2 * fValue//floor((1 / 0.01) * fValue)   // inversed mass
